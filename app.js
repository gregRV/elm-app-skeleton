...
Elm.App.make = function (_elm) {
   ...
   var _op = {};
   var view = F2(function (address,model) {    return A2($Html.p,_U.list([]),_U.list([$Html.text(model.message)]));});
   var update = F2(function (action,model) {    var _p0 = action;return model;});
   var NoOp = {ctor: "NoOp"};
   var initialModel = {message: "Hello, world!"};
   var main = $StartApp$Simple.start({model: initialModel,view: view,update: update});
   var Model = function (a) {    return {message: a};};
   return _elm.App.values = {_op: _op,Model: Model,initialModel: initialModel,NoOp: NoOp,update: update,view: view,main: main};
};
